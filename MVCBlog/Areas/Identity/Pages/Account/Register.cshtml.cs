...
namespace MVCBlog.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private readonly IBlogEmailSender _emailSender; //public access modifier in IBlogEmailSender Interface required
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new BlogUser {
                    ...
                    Email = Input.Email,
                    //Gather user inputted image data or assign default image if null
